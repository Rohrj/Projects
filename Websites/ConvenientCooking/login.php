...
<fieldset>
    ...
    <p>
        ...
        <input type="text" class="required" name="uname" id="uname" placeholder="Gerald94...">
    </p>
    <p>
        <label for="pswd">Password:</label>
        <input type="password" class="required" name="pswd" id="pswd" placeholder="Password1234...">
    </p>
...
<fieldset>
    ...
    <p>
        ...
        <input type="text" class="required" name="fname" id="fname" placeholder="Gerald...">
    </p>
    <p>
        <label for="lname">Last Name:</label>
        <input type="text" class="required" name="lname" id="lname" placeholder="Jackson...">
    </p>
    <p>
        <label for="uname">Username:</label>
        <input type="text" class="required" name="uname" id="uname" placeholder="Gerald94...">
    ...
    <p>
        ...
        <input type="text" class="required" name="email" id="email" placeholder="gerja@gmail.com...">
    </p>
